    ...
    return (
        <div className="alt-container px-2 pb-4 h-full">
            <div className="rounded p-4 flex flex-col gap-4 items-center justify-start bg-foreground-50">
                <h1 className="text-3xl font-bold text-foreground-900">Create a Nisades</h1>
                <p className="text-foreground-900">Write your Nisades here</p>
                ...
                <div className="w-full flex flex-col justify-center gap2">
                    ...
                    <Input
                        key="title"
                        type="text"
                        description="Enter the title of your Nisades"
                        variant="faded"
