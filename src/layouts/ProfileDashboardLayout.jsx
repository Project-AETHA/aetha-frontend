...
export default function ProfileDashboardLayout(props) {
  const menus = [
    {
      ...
      subMenus: [
        ...
        {
          name: "Inbox",
          link: "/profile/edit/inbox",
          icon: RiFolderReceivedFill,
        },
        {
          name: "Sent Items",
          link: "/profile/edit/sentitems",
    ...
    },
    {
      ...
      subMenus: [
        ...
        {
          name: "Settings",
          link: "/profile/edit/settings",
          icon: TbSettingsCog,
        },
        { name: "Premium", link: "/profile/edit/premium", icon: GoStar },
        {
          name: "Achievements",
          link: "/profile/edit/achievements",
          icon: FaTrophy,
        },
        {
          name: "Refer A Friend",
          link: "/profile/edit/referafriend",
          icon: FaEnvelope,
        },
      ],
    },
    {
      ...
      subMenus: [
        {
          name: "Change Email",
          link: "/profile/edit/changeemail",
          icon: FaEnvelope,
        },
        {
          name: "Change Password",
          link: "/profile/edit/changepwd",
          icon: FaLock,
        },
        {
          name: "Two Factor Auth",
          link: "/profile/edit/twofactorauth",
          icon: FaKey,
        },
        {
          name: "External Logins",
          link: "/profile/edit/externallogin",
          icon: FaExternalLinkSquareAlt,
        },
        {
          name: "Download Account",
          link: "/profile/edit/downloadacc",
          icon: FaDownload,
        },
        {
          name: "Delete Account",
          link: "/profile/edit/deleteacc",
          icon: FaUserAltSlash,
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          link: "/profile/edit/notifications",
          icon: MdNotificationImportant,
        },
        {
          name: "Notification History",
          link: "/profile/edit/notificationhistory",
          icon: IoNotifications,
        },
      ],
    },
    {
      ...
      subMenus: [
        ...
        {
          name: "Follow List",
          link: "/profile/edit/myfollowlist",
          icon: IoBookmark,
        },
        {
          name: "Favorites",
          link: "/profile/edit/myfavorites",
          icon: MdOutlineFavorite,
        },
        {
          name: "Read Later",
          link: "/profile/edit/myreadlater",
          icon: MdWatchLater,
        },
        {
          name: "Reading History",
          link: "/profile/edit/myreadinghistory",
          icon: FaHistory,
        },
        { name: "Reviews", link: "/profile/edit/myreviews", icon: BsStarHalf },
        {
          name: "Comments",
          link: "/profile/edit/mycomments",
          icon: FaComments,
        },
        {
          name: "Blocked Users",
          link: "/profile/edit/myblockedusers",
          icon: FaUsersSlash,
        },
      ],
    },
  ...
  return (
    <div className="flex overflow-hidden max-h-[calc(100vh-65px)]">
      <Sidebar menus={menus} />
      <div
        className={`${props.class} w-full overflow-y-scroll default-scrollbar`}
      >
        <BreadCrumbs />
        {props.children}
      </div>
