                ...
                <div className="flex flex-col md:flex-row gap-4 !p-0">
                    <div className="shadow-2xl bg-foreground-50 w-full rounded-md p-2">
                        <div className="m-auto">
                            ...
                            <div className="md:flex m-2 border-1 md:border-0 border-blue-200">
                                ...
                                <div className="md:w-10/12 w-full inline-block md:border border-blue-200 md:m-2">
                                    ...
                                    <hr className="mx-5 border-blue-200" />
                            ...
                            <div className="mt-5 md:flex m-2 border-1 md:border-0 border-blue-200">
                                <div className="md:w-[140px] w-full inline-block md:m-2  my-2">
                                    <img src="../../public/images/user.png" className="m-auto w-28" />
